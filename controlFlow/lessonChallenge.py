...
print("Insert IP address. An IP address consists of 4 numbers, separated from each other with a full stop:  ")
ipAddress = input()
if ipAddress[-1] != '.':
    ipAddress += '.'

#Initialize two variables.
segment = 1 #Counter of how many segments there are.
segment_length = 0
# character = ""
